...
public final class  Updater {
    ...
    // Attributes
    public static final String GITHUB_REPOSITORY_NAME = "Hackathon2025";
    public static final String GITHUB_PAGE = "https://github.com/ItalianDudes/" + GITHUB_REPOSITORY_NAME;
    public static final String GITHUB_LATEST_PAGE = GITHUB_PAGE + "/releases/latest";
    private static final String GITHUB_LATEST_DOWNLOAD_PART = GITHUB_LATEST_PAGE + "/download/" + GITHUB_REPOSITORY_NAME + "-";

    // Methods
    @Nullable
    public static String getLatestVersion() {
        try {
            URL url = new URI(GITHUB_LATEST_PAGE).toURL();
    ...
    public static void downloadNewVersion(@NotNull final String destPath) throws IOException, URISyntaxException {
        ...
        String downloadURL = GITHUB_LATEST_DOWNLOAD_PART + latestVersion + "-" + IDDefs.CURRENT_PLATFORM.getManifestTargetPlatform().toUpperCase() + ".jar";
