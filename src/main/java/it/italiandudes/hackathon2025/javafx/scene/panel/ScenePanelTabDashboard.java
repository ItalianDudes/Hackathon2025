...
import it.italiandudes.hackathon2025.javafx.controllers.panel.ControllerScenePanelTabDashboard;
...
public final class ScenePanelTabDashboard {
    ...
    private static SceneController genScene(@NotNull final ControllerScenePanelMain mainController) {
        try {
            FXMLLoader loader = new FXMLLoader(ResourceGetter.getResource(JFXDefs.Resources.FXML.Panel.FXML_PANEL_TAB_ANALYTICS));
            Parent root = loader.load();
            ControllerScenePanelTabDashboard controller = loader.getController();
