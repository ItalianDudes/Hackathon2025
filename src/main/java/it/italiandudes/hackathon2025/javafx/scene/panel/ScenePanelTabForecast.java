...
import it.italiandudes.hackathon2025.javafx.controllers.panel.ControllerScenePanelTabForecast;
...
public final class ScenePanelTabForecast {
    ...
    private static SceneController genScene(@NotNull final ControllerScenePanelMain mainController) {
        try {
            FXMLLoader loader = new FXMLLoader(ResourceGetter.getResource(JFXDefs.Resources.FXML.Panel.FXML_PANEL_TAB_FORECAST));
            Parent root = loader.load();
            ControllerScenePanelTabForecast controller = loader.getController();
