...
import it.italiandudes.hackathon2025.javafx.controllers.panel.ControllerScenePanelTabControls;
...
public final class ScenePanelTabControls {
    ...
    private static SceneController genScene(@NotNull final ControllerScenePanelMain mainController) {
        try {
            FXMLLoader loader = new FXMLLoader(ResourceGetter.getResource(JFXDefs.Resources.FXML.Panel.FXML_PANEL_TAB_CONTROLS));
            Parent root = loader.load();
            ControllerScenePanelTabControls controller = loader.getController();
