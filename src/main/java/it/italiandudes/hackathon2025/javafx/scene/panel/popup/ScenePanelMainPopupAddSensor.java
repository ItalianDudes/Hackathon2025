...
public final class ScenePanelMainPopupAddSensor {
    ...
    private static SceneController genScene(@NotNull final Sector sector) {
        try {
            FXMLLoader loader = new FXMLLoader(ResourceGetter.getResource(JFXDefs.Resources.FXML.Panel.Popup.FXML_POPUP_ADD_SENSOR));
            Parent root = loader.load();
            ControllerScenePanelMainPopupAddSensor controller = loader.getController();
