...
import it.italiandudes.hackathon2025.javafx.controllers.ControllerSceneMainMenu;
...
public final class SceneMainMenu {
    ...
    private static SceneController genScene() {
        try {
            FXMLLoader loader = new FXMLLoader(ResourceGetter.getResource(JFXDefs.Resources.FXML.FXML_MAIN_MENU));
