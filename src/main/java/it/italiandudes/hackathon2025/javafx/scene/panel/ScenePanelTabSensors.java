...
public final class ScenePanelTabSensors {
    ...
    private static SceneController genScene(@NotNull final ControllerScenePanelMain mainController) {
        try {
            FXMLLoader loader = new FXMLLoader(ResourceGetter.getResource(JFXDefs.Resources.FXML.Panel.FXML_PANEL_TAB_SENSORS));
            Parent root = loader.load();
            ControllerScenePanelTabSensors controller = loader.getController();
